...
class JsontestController extends Zend_Controller_Action {
    ...
    public function indexAction(){
        ...
        switch ($strType) {
            case "refresh_list":
                ...
                $_SESSION["Setting"]["PDTTicketCategoryID"] = '1';
            ...
            case "call_customer":
                ...
                if ($arrTicket["TicketID"]) {
                    ...
                    $modelTicket->updateCalledDateTest($arrTicket["TicketID"], $strCounterNo, $strCurrTime, 'test');
