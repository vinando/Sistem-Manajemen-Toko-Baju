 ...
 */
class TrnpenggunaanbahanController extends Zend_Controller_Action {
    private $model;
    public function init() {
        $this->model = new Application_Model_Trnpenggunaanbahan();
        $this->view->AccordionID  = "Transaction";
        $this->view->SelectedMenu = "Penggunaanbahan";
    }
    ...
    public function formAction(){
        switch ($this->getRequest()->getParam("type")) {
            ...
            case "edit":
                ...
                $this->view->assign("OrderId", $trn['orderid']);
                $this->view->assign("OrderNo", $trn['orderno']);
    ...
    public function saveAction() {
        ...
        switch ($this->getRequest()->getParam("type")) {
            case "Add":
                ...
                $trn_id = $this->model->insertHeader($branch_id, $order_id, $order_no, $trn_no, $trn_date);
                $trn_no = 'URM-' . $branch_id . '-' . $trn_id;
            ...
            case "Edit":
                $trn_no = $data['TrnNo'];
                $this->model->updateHeader($trn_id, $branch_id, $order_id, $order_no, $trn_no, $trn_date);
